...
-(void)sure{
    ...
    if (_delegate &&[_delegate respondsToSelector:@selector(XMClickedButtonAtIndex:)]) {
        
        [_delegate XMClickedButtonAtIndex:1];
    }
}
//警告框显示
-(void)showAlert{
